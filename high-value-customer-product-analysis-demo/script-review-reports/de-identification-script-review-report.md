...
**脚本文件**：`scripts/de-identification-reverse.py`  
...
- **输入**：`analysis-results/analysis-report.md`
- **输出**：`analysis-results/real-conclusions/analysis-report.md`
...
- **输入/输出**：`analysis-results/高价值客户产品分析结果.xlsx` → `analysis-results/real-conclusions/高价值客户产品分析结果.xlsx`
...
- **映射文件**：`data/映射记录.json`
- **输入文件**：`analysis-results/analysis-report.md`、`analysis-results/高价值客户产品分析结果.xlsx`
- **输出目录**：`analysis-results/real-conclusions/`（自动创建）
